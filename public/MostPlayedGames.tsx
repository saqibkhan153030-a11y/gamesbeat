...
const games = [
  { name: "Tom & Jerry Broom Riders", image: "/mostplayed1.jpg" },
  { name: "StarWars Battlerun", image: "/mostplayed2.jpg" },
  { name: "Barbie Make Up", image: "/mostplayed3.jpg" },
  { name: "Spiderman Mysterio Rush", image: "/mostplayed4.jpg" },
  { name: "Star Wars Rebels", image: "/mostplayed5.jpg" },
  { name: "Kunfu Panda Paw some", image: "/mostplayed6.jpg" },
];
  ...
  return (
    ...
    {/* ================= BACKGROUND ================= */}
      ...
      <div
        ...
        style={{ backgroundImage: "url('/mostplayedbg-mobile.png')" }} 
      ...
      <div
        ...
        style={{ backgroundImage: "url('/mostplayedbg.png')" }}
      />
